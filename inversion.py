...
from utils.deis_inv import DEISInversion
from utils.scheduler import DEISInverseScheduler
...
if __name__=="__main__":
    ...
    pipe = DEISInversion.from_pretrained(args.model_path, torch_dtype=torch_dtype).to(device)
    pipe.scheduler = DEISInverseScheduler.from_config(pipe.scheduler.config)
